        ...
        <div class="box-body table-responsive" style="padding-top: 0px;">
          <table class="table table-hover table-striped table-f12">
            ...
            <tbody>
              ...
              <tr data-id="{{$item->id}}" data-nro-contrato="{{$item->nro_contrato}}" data-nro-doc="{{$item->nro_doc}}" data-nombre="{{$item->nombre_completo}}" data-cargo="{{$item->cargo}}">
                <td>{{$item->id}}</td>
                <td class="right">
...
<script>
  ...
  $(document).ready(function(){
    $('.btn-delete').click(function(){
      ...
      var id = row.data('id');
      var nro_doc = row.data('nro-doc');
      var nombre = row.data('nombre');
      var cargo = row.data('cargo');
      console.log(nombre);
      $('#id').val(id);
      $('#nro-doc').text(nro_doc);
      $('#nombre').text(nombre);
      $('#cargo').text(cargo);
    });
